      ...
      <div className='max-w-2xl sm:py-6 mx-auto'>
        <div className='bg-white rounded-lg shadow p-6'>
            ...
            <div className='flex flex-col items-start gap-3'>
                <label htmlFor="cover_photo" className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div className='group/cover relative'>
                        <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt="" className='w-80 h-40 rounded-lg bg-gradient-to-r from-orange-200 via-red-200 to-yellow-200 object-cover mt-2'/>
            ...
            <div className='flex justify-end space-x-3 pt-6'>
                ...
                <button type='submit' className='px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:from-orange-600 hover:to-red-700 transition cursor-pointer'>Save Changes</button>
            </div>
